...
script_version(3.30) 						            -- Óêàçûâàåì âåðñèþ ñêðèïòà / FINAL
...
local nicks = { -- [''] = '',
-- 12+
  ['Yupi_Mean'] = 'Þïèê', -- Ãåíåðàë.
  ['Sonny_Raylonds'] = '×óïåíäèêñ', -- Ïîëêîâíèê.
...
-- Êîì. ñîñòàâ.
  ['Alex_Frank'] = 'Íåìåö', --Êóðàòîð.
  ['Sergey_Fibo'] = 'Ïàíäà', -- Êîìàíäèð.
   -- Çàì. Êîìàíäèðà.
  ['Suetlan Zelimxanov'] = 'Ñóåòà', -- Çàì. Êîìàíäèðà.
...
-- Ñòàæåðû.
  ...
  ['Henry_Markano'] = 'Õàíê',
  ['Sofiya_Murphy'] = 'Ñìóðô',
  ['William_Lattice'] = 'Ðîëåêñ',
  ['Gabriel_Olimpov'] = 'Áëó',
  ['Near_Alpinstar'] = 'Ïåðñèê',
  ['Shane_Prix'] = 'Îðëèê',
  ['Aleks_Bichovski'] = 'Øàòàé',
